...
const Navbar = () => {
    return (
        <div className="sticky top-0 z-50 bg-[#00308F] "><header className="text-gray-600 body-font">
  ...
  src={logo}  width={100} height={100} alt="logo"
                ...
                <nav className=" text-white md:ml-auto md:mr-auto sm:space-x-1 space-x-2  md:space-x-2 sm:gap-6 gap-4 flex flex-wrap items-center text-s sm:text-lg justify-center">
               ...
               <a className="rounded-sm items-center px-1 hover:text-[#440101] hover:bg-gray-100 border-0 py-0  w-max-full hover:font-semibold  inline-flex" href="/assets/cv/BILAL AHMED with picture.pdf">
                 <button className=" text-s pr-1 hidden sm:block focus:outline-none hover:bg-none  sm:text-base mt-4 md:mt-0">Resume
                
                </button>
                < IoCloudDownloadOutline  className="p-0 mt-2    sm:text-3xl text-2xl text-center sm:mt-1 pr-1"/></a>
            </div>
        </header></div>
    )
}
