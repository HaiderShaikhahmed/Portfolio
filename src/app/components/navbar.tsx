...
const Navbar = () => {
  ...
  src={logo}  width={100} height={100} alt="logo"
                ...
                <nav className="md:ml-auto md:mr-auto space-x-5 gap-6 flex flex-wrap items-center text-base justify-center">
                    ...
                    <Link href={"#contact"}className="mr-5  border-b hover:shadow-lg hover:w-15 hover:text-blue-600">Contact us </Link>
                </nav>
               <a href="/assets/cv/Exploring-the-Universe.pdf">
                 <button className="inline-flex items-center hover:text-[#440101] hover:bg-gray-100 border-0 py-1 w-auto   px-4 focus:outline-none hover:bg-none rounded text-base mt-4 md:mt-0">click Here to Download
